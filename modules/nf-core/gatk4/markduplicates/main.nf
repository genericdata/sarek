process GATK4_MARKDUPLICATES {
    ...
    output:
    tuple val(meta), path("${prefix_bam}")         emit: bam,   optional: true
    tuple val(meta), path("${prefix_bam}.bai"),    emit: bai,   optional: true
    tuple val(meta), path("${prefix}"),            emit: cram,  optional: true
